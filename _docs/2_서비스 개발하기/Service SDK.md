...
**입력한 Invoke를 개발 환경에서 테스트 하기 위해서는 Dialog Kit의 통합 시험 배포 과정을 거쳐야 합니다.**  통합 시험 배포 환경은 [「2.8 개발 환경 배포 하기」](https://ktaidevelopers.github.io/2_서비스 개발하기/개발 환경 배포하기/){: target="_blank"}에서 설명하겠습니다. 
